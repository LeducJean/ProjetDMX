...
const List = React.createClass({ displayName: "List",
  getInitialState() {
    return {
      mouse: [0, 0],
        ...
        return (
          column.map(row => {
            ...
            return /*#__PURE__*/(
              ...
              ({ translateX, translateY, scale }) => /*#__PURE__*/
...
ReactDOM.render( /*#__PURE__*/React.createElement(List, null), document.getElementById('react-root'));