; (function ($, window, undefined) {
  ...
  Plugin.prototype.init = function () {
    ...
    droppables.on({
      ...
      'drop': function (ev) {
        // Check if there is already an element in the "Scène activée" section
        if ($(this).find('.task').length === 0) {
          ...
          // Display an error message or disable drop functionality
          alert("Vous ne pouvez ajouter qu'un seul élément dans la section 'Scène activée'.");
          return false;
        }
      },
      'dragover': function (ev) {
    ...
    // Remaining draggables and appendables logic...
  };
